  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action="proses/santri_proses_tambah.php" method="post" class="form-horizontal">
              <!-- <div class="box-body"> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tanggal_lahir" class="form-control tanggal" placeholder="Tanggal Lahir">
                  </div>
                </div>
                <div class="form-group">
